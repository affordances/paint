    ...
    if (newBristleCount > this.bristleCount) {
      var setBristlesDrawState = wgl
        ...
        .viewport(
          this.bristleCount,
          0,
          newBristleCount - this.bristleCount,
          VERTICES_PER_BRISTLE
        )
  ...
  Brush.prototype.update = function (x, y, z, scale) {
    ...
    for (var i = 0; i < ITERATIONS; ++i) {
      ...
      for (var pass = 0; pass < 2; ++pass) {
        ...
        Utilities.swap(
          this,
          "projectedPositionsTexture",
          "projectedPositionsTextureTemp"
        );
      }
    ...
    var updateVelocityDrawState = wgl
      .createDrawState()
