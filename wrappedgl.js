...
var WrappedGL = (function () {
  ...
  WrappedGL.prototype.canRenderToTexture = function (type) {
    ...
    var result =
      this.checkFramebufferStatus(framebuffer) === gl.FRAMEBUFFER_COMPLETE;
  ...
  WrappedGL.prototype.getShaderPrecisionFormat = function (
    shaderType,
    precisionType
  ) {
  ...
  WrappedGL.prototype.hasHalfFloatTextureSupport = function () {
    ...
    if (this.getExtension("OES_texture_half_float_linear") === null)
      return false;
  ...
  WrappedGL.prototype.hasFloatTextureSupport = function () {
    if (
      this.getExtension("OES_texture_float") === null ||
      this.getExtension("OES_texture_float_linear") === null
    )
      return false;
