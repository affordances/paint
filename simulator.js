var Simulator = (function () {
  ...
  Simulator.prototype.copyTexture = function (
    destinationWidth,
    destinationHeight,
    sourceTexture,
    destinationTexture
  ...
  Simulator.prototype.getSimulationArea = function () {
    ...
    simulationArea.intersectRectangle(
      new Rectangle(0, 0, this.resolutionWidth, this.resolutionHeight)
    );

    return simulationArea;
  };

  Simulator.prototype.splat = function (
    brush,
    zThreshold,
    paintingRectangle,
    splatColor,
    ...
    var splatPaintDrawState = wgl
      ...
      .scissor(
        simulationArea.left,
        simulationArea.bottom,
        simulationArea.width,
        simulationArea.height
      )
      ...
      .uniform2f(
        "u_paintingPosition",
        paintingRectangle.left,
        paintingRectangle.bottom
      )
      ...
      .uniformTexture(
        ...
        0,
        wgl.TEXTURE_2D,
        brush.positionsTexture
      )
      .uniformTexture(
        "u_previousPositionsTexture",
        1,
        wgl.TEXTURE_2D,
        brush.previousPositionsTexture
      )
    ...
    var splatVelocityDrawState = wgl
      .createDrawState()
      .bindFramebuffer(this.simulationFramebuffer)
      .viewport(0, 0, this.resolutionWidth, this.resolutionHeight)
      ...
      .uniformTexture(
        ...
        2,
        wgl.TEXTURE_2D,
        brush.velocitiesTexture
      )
      .uniformTexture(
        "u_previousVelocitiesTexture",
        3,
        wgl.TEXTURE_2D,
        brush.previousVelocitiesTexture
      )
      .uniform1f("u_zThreshold", zThreshold)
  ...
  Simulator.prototype.simulate = function () {
    ...
    while (i--) {
      if (
        this.frameNumber - this.splatAreas[i].frameNumber >
        FRAMES_TO_SIMULATE
      ) {
